...
\exercice{Renseignez-vous sur la fonction \inlincode{After} du paquet \inlinecode{time}. Modifiez \file{select.go} en ajoutant une condition dans le \inlinecode{select} pour limiter l'attente à 500ms.}
